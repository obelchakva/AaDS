...
def test_ascii85_encoding():
    ...
    encoded_with_base64 = a85encode(data.encode()).decode()
...
def test_ascii85_decoding():
    encoded_data = a85encode(generate_random_data(100).encode()).decode()
    decoded_with_base64 = a85decode(encoded_data.encode()).decode()
